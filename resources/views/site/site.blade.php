...
<!-- header -->
<header id="site-header" class="w3l-header fixed-top" style="background-color: #20b9d6">
    <!--/nav-->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a style="color: white" class="nav-link" href="about.html">Sobre Nós</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: white" class="nav-link" href="genre.html">Categorias</a>
                    </li>

                    <li class="nav-item">
                        <a style="color: white" class="nav-link" href="contact.html">Contato</a>
                    </li>
                </ul>
                ...
                @forelse($categorias as $categoria)
                    <div class="w3l-title-grids">
                        <div class="headerhny-left">
                            <h3 class="hny-title">{{$categoria->name}}</h3>
                        </div>
                        <div class="headerhny-right text-lg-right">
                            <h4><a class="show-title" href="genre.html">Exibir Todas</a></h4>
                        </div>
                    </div>
                        ...
                        <div class="w3l-populohny-grids">
                            ...
                            <div class="item vhny-grid">
                                <div class="box16">
                                    <a href="genre.html">
                                        <figure>
                                            <img class="img-fluid" src="{{$cartao->caminho}}" alt="">
                                        </figure>
                                        <div class="box-content">
                                            <h3 class="title">{{$cartao->name}}</h3>
