...
<div class="container">
    <div class="row">
        <div style="margin-top: -100px" class="col-md-5 mx-auto">
            <center>
            <img width="70%" class="img img-fluid" src="{{asset('logo.jpg')}}" alt="">
            </center>
            <div id="first">
                ...
                <div class="myform form ">
                    ...
                    <form action="#" name="registration">
                        <div class="form-group">
                            ...
                            <input type="text"  name="firstname" class="form-control" id="firstname" aria-describedby="emailHelp" placeholder="Digite seu nome completo">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">CPF</label>
                            <input type="text"  name="firstname" class="form-control" id="firstname" aria-describedby="emailHelp" placeholder="Digite seu CPF">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Telefone/Whatsapp</label>
                            <input type="text"  name="firstname" class="form-control" id="firstname" aria-describedby="emailHelp" placeholder="Digite seu telefone ou whatsapp">
                        </div>
